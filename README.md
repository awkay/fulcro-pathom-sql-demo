...
`src/main/sql_pathom_demo/client.cljs` contains the code to start and refresh
...
application `sql-pathom-demo.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/sql_pathom_demo.jar
```
